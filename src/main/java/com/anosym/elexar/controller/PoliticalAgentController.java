...
public class PoliticalAgentController implements Serializable {
    ...
    private static final Map<String, Integer> CONFIGURATION_TABS = new HashMap<>();
    ...
    public void handleUploadCandidateImage(FileUploadEvent event) {
        ...
        try {
            final File candidateImageFile = new File(getPoliticalAgentResourceUrl(), file.getFileName());
            try (FileOutputStream out = new FileOutputStream(candidateImageFile)) {
